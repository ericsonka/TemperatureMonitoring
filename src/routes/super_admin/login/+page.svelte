<script>
    ...
    async function handle_login(e) {
        ...
        let response = await fetch("/api/super_admin/login_api", {
            method: "POST",
...
<section>
    <form class="form_container">
        ...
        <div class="title_container">
            <p class="title">sign your Account</p>
            <span class="subtitle"
        ...
        <div class="input_container">
            <label class="input_label" for="email_field">FULL NAME</label>
            <svg
                fill="none"
                viewBox="0 0 24 24"
                height="24"
        ...
        <button type="submit" class="sign-in_btn" on:click={handle_login}>
            <span >Sign In</span>
        </button>
        ...
        <!-- <button title="Sign In" type="submit" class="sign-in">
            <span>Sign up</span>
        </button>
             -->
    </form>
