<script>
    ...
    async function insert_devices() {
        let response = await fetch("/api/super_admin/add_admin", {
            method: "POST",
...
<section>
    <form class="form_container">
        <div class="logo_container">
            <img src="/admin/logo/logo.jpg" alt="" />
        </div>
        <div class="title_container">
            <p class="title">Add Admin Account</p>
        </div>
        <br />
        <div class="input_container">
            ...
            <input
                ...
                type="text"
                class="input_field"
                bind:value={registration_data.name}
                required
            />
        </div>
        <div class="input_container">
            ...
            <input
                ...
                class="input_field"
                required
                bind:value={registration_data.email}
            />
        </div>
        <div class="input_container">
            ...
            <input
                ...
                id="password_field"
                required
                bind:value={registration_data.password}
            />
        </div>
        <p>{message}</p>
        <button title="Sign In" type="submit" class="sign-in_btn" on:click={insert_devices} >
